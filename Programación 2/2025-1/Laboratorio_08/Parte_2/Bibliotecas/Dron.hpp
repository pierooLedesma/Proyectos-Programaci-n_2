...
#ifndef PARTE_2_DRON_HPP
#define PARTE_2_DRON_HPP
...
public:
    ...
    virtual bool es_semaforo() const; // Método polimórfico

    virtual bool es_estacionamiento() const; // Método polimórfico

    virtual void contar(int & cantidad_drones); // Método polimórfico

    virtual void actualizar() = 0; // Método puro
